...
namespace WebApplicationParkinson.Controllers
{
    ...
    {
        private readonly IConfigurationRoot _configuration1;
        private readonly IGallery1Service _gallery1Service;
        private readonly ServiceContext _serviceContext;

        public Gallery1Controller(IConfigurationRoot configuration1, IGallery1Service gallery1Service, ServiceContext serviceContext)
        {
